...
function buildSteps(target: number): Step[] {
  return [
    ...
    {
      title: 'Обирай пару і дію',
      body: 'Натисни на картку, потім знак (+, −, ×, ÷), потім другу картку.',
      demo: <OpDemo />,
    },
    {
      title: 'Результат стає карткою',
      body: 'Використовуй її в наступних ходах, поки не добереш ціль.',
      demo: <ChainDemo />,
    },
    {
      title: 'Точніше — більше зірок',
      body: 'Точно в ціль — 3★, у межах 10 — 2★, у межах 20 — 1★.',
      demo: <StarsDemo />,
    },
  ];
}
